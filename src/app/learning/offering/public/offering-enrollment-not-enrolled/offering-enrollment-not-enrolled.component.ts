...
@Component({
    selector: 'spk-offering-enrollment-not-enrolled',
    templateUrl: './offering-enrollment-not-enrolled.component.html',
    styleUrls: ['./offering-enrollment-not-enrolled.component.scss']
})
export class OfferingEnrollmentNotEnrolledComponent implements OnInit {
    ...
    columns: Column[] = [
        ...
        // { title: '更新日期', data: 'lastModifiedDate'},
    ...
    loadData(page?, params = {}) {
        ...
        this.loading = true;
        this.offeringEnrollmentApi.getNotEnrolled(this.offeringId, params, page).subscribe(
            data => {
                this.data = data;
                this.loading = false;
                this.exportIsShow();
    ...
    userExport(params = {}) {
        ...
        params = this._searchForm ? this._searchForm.value : {};
        params["enrollResult"] = "notEnrolled";
        if (this.selection) {
