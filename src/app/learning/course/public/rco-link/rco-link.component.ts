...
@Component({
  selector: 'spk-rco-link',
  templateUrl: './rco-link.component.html',
  styleUrls: ['./rco-link.component.scss']
})
export class RcoLinkComponent implements OnInit {
  ...
  initForm() {
    this._form = this.fb.group({
      title: [],
      startingUrl: [], // TODO: 校验链接是否可用，不可用时，警告，再点确定可以提交
      description: [],
      trackingType: ['AUTO']
    });
  }
