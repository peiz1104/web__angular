...
@Component({
    selector: 'spk-training-office-assessment',
    templateUrl: './training-office-assessment.component.html',
    styleUrls: ['./training-office-assessment.component.scss']
})

export class TrainingOfficeAssessmentComponent implements OnInit {
