...
@Component({
  selector: 'spk-training-class-exam-arrange',
  templateUrl: './training-class-exam-arrange.component.html',
  styleUrls: ['./training-class-exam-arrange.component.scss']
})
export class TrainingClassExamArrangeComponent implements OnInit {
  allData: any = {};
  columns: any = [
