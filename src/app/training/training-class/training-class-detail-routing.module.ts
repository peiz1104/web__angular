...
import { TrainClassAssessmentComponent } from './views/train-class-assessment/train-class-assessment.component';
import { TrainClassAttendanceComponent } from './views/train-class-attendance/train-class-attendance.component'
import { TrainClassAttendancelistComponent } from './views/train-class-attendancelist/train-class-attendancelist.component';
import { TrainClassAttendancenewPersonComponent } from './views/train-class-attendancenew-person/train-class-attendancenew-person.component';
        ...
        children: [
            {
                path: '', children: [
                    ...
                    {
                        path: 'courses', resolve: { trainingClass: TrainingClassDetailNewResolver }, children: [
...
export class TrainingClassDetailRoutingModule { }
...
export const routedComponents = [
    ...
    CaseEditComponent,
    CaseInfoComponent,
    OfficeTeacherDetailComponent,
    TrainingClassCourseAddComponent,
    TrainingClassForumComponent,
    TrainingClassCourseForumComponent,
    TrainClassGroupCourseComponent,
