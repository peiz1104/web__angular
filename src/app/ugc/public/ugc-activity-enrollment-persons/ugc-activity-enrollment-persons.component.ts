...
@Component({
    selector: 'spk-ugc-activity-enrollment-persons',
    templateUrl: './ugc-activity-enrollment-persons.component.html',
    styleUrls: ['./ugc-activity-enrollment-persons.component.scss']
})
export class UgcActivityEnrollmentPersonsComponent implements OnInit {
    ...
    @Input() selectedLoading: boolean = false;
    columns: Column[] = [
    ...
    loadData(page?: any) {
        ...
        this.ugcActivityEnrollmentService.notEnrollments(this.id, params).subscribe(
            obj => {
                this.data = obj;
