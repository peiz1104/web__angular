...
@Component({
  selector: 'spk-ugc-activity-messages-persons',
  templateUrl: './ugc-activity-messages-persons.component.html',
  styleUrls: ['./ugc-activity-messages-persons.component.scss']
})
export class UgcActivityMessagesPersonsComponent implements OnInit {
  ...
  loadData(page?: any) {
    ...
    this.ugcActivityMessageService.getPersons(this.id, params).subscribe(
      obj => {
        this.data = obj;
