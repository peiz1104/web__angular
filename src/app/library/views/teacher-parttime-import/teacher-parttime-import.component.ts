...
@Component({
  selector: 'spk-teacher-parttime-import',
  templateUrl: './teacher-parttime-import.component.html',
  styleUrls: ['./teacher-parttime-import.component.scss']
})
export class TeacherParttimeImportComponent implements OnInit {
    ...
    constructor(
      ...
      private service: TeacherPartService
    ) { }
    ...
    import() {
      ...
      this.service.import(this.taskKey).subscribe(
        errorList => {
