...
@Component({
    selector: 'spk-headofficefile',
    templateUrl: './headofficefile.component.html',
    styleUrls: ['./headofficefile.component.scss']
})
export class HeadofficefileComponent implements OnInit {
    ...
    loadData(page?: Pagination<any>) {
        ...
        this.trainBaseService.getCompanyDocuments(params).subscribe(data => {
            this.spinning = false;
    ...
    initForm() {
        this._form = this.fb.group({
            ...
            fileType: ['总公司文件', [Validators.required]]
        })
    }
    // 添加
    add() {
