...
@Component({
    selector: 'spk-headofficematerialtemplate',
    templateUrl: './headofficematerialtemplate.component.html',
    styleUrls: ['./headofficematerialtemplate.component.scss']
})
export class HeadofficematerialtemplateComponent implements OnInit {
    ...
    columns: any = [
        ...
        { title: '模板名称', tpl: 'declaredisPlayName', styleClass: 'text-left' },
    ...
    loadData(page?: Pagination<any>) {
        ...
        if (this.searchBy.templateName) {
            params['publicName'] = this.searchBy.templateName;
        }
        if (this.searchBy.userGroup) {
            params['userGroup.id'] = this.searchBy.userGroup.id;
        }
        this.trainBaseService.getCompanyTemplate(params).subscribe(data => {
            this.spinning = false;
    ...
    initForm() {
        this._form = this.fb.group({
            ...
            fileType: ['总公司报送材料模板列表', [Validators.required]]
        })
    }
    // 添加
    add() {
