...
@Component({
    selector: 'spk-headofficeeducation',
    templateUrl: './headofficeeducation.component.html',
    styleUrls: ['./headofficeeducation.component.scss']
})
export class HeadofficeeducationComponent implements OnInit {
    ...
    columns: any = [
        ...
        { title: '制度名称', tpl: 'declaredisPlayName', styleClass: 'text-left' },
    ...
    loadData(page?: Pagination<any>) {
        ...
        if (this.searchBy.systemName) {
            params['publicName'] = this.searchBy.systemName;
        }
        if (this.searchBy.userGroup) {
            params['userGroup.id'] = this.searchBy.userGroup.id;
        }
        this.trainBaseService.getCompanyEdu(params).subscribe(data => {
            this.spinning = false;
    ...
    initForm() {
        this._form = this.fb.group({
            ...
            fileType: ['教育培训制度', [Validators.required]]
        })
    }
    // 添加
    add() {
