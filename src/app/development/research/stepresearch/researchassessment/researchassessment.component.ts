...
@Component({
    selector: 'spk-researchassessment',
    templateUrl: './researchassessment.component.html',
    styleUrls: ['./researchassessment.component.scss']
})
export class ResearchassessmentComponent implements OnInit {
    @Input() id: any;
    @Input() phaseId: any;
    _form: FormGroup;
    document: any = {};
    ...
    columns = [
        { title: '阶段评估名称', tpl: 'name', styleClass: 'text-left' },
        { title: '附件名称', tpl: 'fileName', styleClass: 'text-left text-overflow' },
        { title: '阶段备注', tpl: 'remark', styleClass: 'text-left' },
