...
import { ExaminationService } from 'app/exam/exam-reuse/service/examination.service';
...
export class ExamFormComponent implements OnInit {
    ...
    initForm() {
        ...
        this.validateForm = this.fb.group({
            ...
            countmCode: [this.examDetail.countmCode || 'HG', [Validators.required]],
    ...
    onSubmit(event: Event, content) {
        ...
        console.log(this.examDetail.paperId, this.validateForm.value.paperId);
        if (this.examDetail.examId && this.examDetail.paperId !== this.validateForm.value.paperId) {
            let req = {
