...
import { ExamCourseRoutingModule, routedComponents } from './exam-course-routing.module';
...
@NgModule({
    imports: [
        SharedModule, ExamCourseRoutingModule, OfferingModule, ViewTestModule
    ],
