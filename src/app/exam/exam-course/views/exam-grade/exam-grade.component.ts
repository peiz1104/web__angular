 ...
 * @Last Modified time: 2018-05-11 11:14:18
 */
...
export class ExamGradeComponent implements OnInit {
    ...
    toReview(row) {
        ...
        this.router.navigate([`/training/class/${this.tbcId}/courses/${this.cache.examWhId}/exam/${this.cache.examId}/review`], { queryParams: { 'userId': row.userId, 'examId': row.examId } })
    }
    // 时间验证方法
